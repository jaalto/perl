...
=back
    ...
    open my $FH, "<", "perlebcdic.pod"    or  die "Could not open perlebcdic.pod: $!";
...
four coded character sets discussed in this document is as follows:
	...
	if (ord '^' == 95   or   ord '^' == 106) { # 1047 || posix-bc
...
For sequential data set access try:
    ...
    my @ds_records = qx(cat //DSNAME);

or:

    my @ds_records = qx(cat //'HLQ.DSNAME');
